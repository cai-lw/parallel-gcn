...
LDFLAGS=-lm -lstdc++
CXXFILES=src/simdxorshift128plus.cpp src/xorshift128plus.cpp src/gcn.cpp src/optim.cpp src/module.cpp src/variable.cpp src/parser.cpp src/rand.cpp
HFILES=src/xorshift128plus.h src/simdaesdragontamer.h src/simdxorshift128plus.h src/gcn.h src/optim.h src/module.h src/variable.h src/sparse.h src/parser.h src/rand.h src/timer.h 
